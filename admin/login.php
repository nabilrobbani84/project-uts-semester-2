                    ...
                    <div class="card" style="border-radius: 1rem;">
                        <div class="row g-0">
                            <div class="col-md-6 col-lg-5 d-none d-md-block">
                                <img src="assets/img/jordan.jpg" alt="login form" class="img-fluid" style="border-radius: 1rem 0 0 1rem;" />
                            </div>
                            <div class="col-md-6 col-lg-7 d-flex align-items-center">
                                <div class="card-body p-4 p-lg-4 text-black">
                                    ...
                                    <form data-parsley-validate="" novalidate="" onsubmit="return false">
                                        ...
                                        <p class="mb-2 pb-lg-1" style="color: #393f81;">Don't have an account? <a href="register2.php" style="color: #393f81;">Register here</a></p>
                                        ...
                                        <div class="toast-container position-fixed bottom-0 end-0 p-3">
                                            <div id="liveToast" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
                                                <div class="toast-header bg-info">
                                                    <img src="../assest/dist/img/avatar.png" class="rounded-circle elevation-2 me-2" style="width: 10%; height: 10%;" alt="admin">

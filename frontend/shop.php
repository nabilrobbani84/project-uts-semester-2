            ...
            <div class="col-lg-9">
                ...
                <div class="row">
                    ...
                    foreach ($data as $produk) {
                        ...
                        echo "<img class='card-img rounded-0 img-fluid' src='assets/img/$produk[foto]'>";
                        ...
                        echo "<a href='shop-single.php' class='h3 text-decoration-none'>$produk[nama]</a>";
                        echo "<ul class='w-100 list-unstyled d-flex justify-content-between mb-0'>";
                        echo "<li>$produk[deskripsi]</li>";
                        echo " <li class='pt-2'>";
                        ...
                        echo "</li>";
                        echo "</ul>";
                        echo "<p class='text-center mb-0'>$$produk[harga_jual].00</p>";
                        echo "</div>";
                        echo "</div>";
                        echo "</div>";
                    }
